...
exports.signup = async (req, res) => {
  ...
  try {
    ...
    console.log(
      `#### ${userCreated.userType} ${userCreated.name} created ####`
    );
...
exports.signin = async (req, res) => {
  try {
    ...
    const accessToken = jwt.sign({ id: user.userId }, authConfig.secret, {
      expiresIn: authConfig.accessTokenTime,
    });
    const refreshToken = jwt.sign({ id: user.userId }, authConfig.secret, {
